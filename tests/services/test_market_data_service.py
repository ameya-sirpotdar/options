...
from backend.services.market_data_service import get_filtered_options


@patch("backend.services.market_data_service.filter_contracts")
@patch("backend.services.market_data_service.fetch_options_chain")
@patch("backend.services.market_data_service.get_access_token")
