...
class TestSchwabAuthEnvVarFallback:
    """Tests for credential resolution in SchwabService."""
    ...
    def test_falls_back_to_env_vars_when_no_vault_url(self):
        ...
        with patch.dict(os.environ, env_vars):
            service = SchwabService(vault_url=None)
    ...
    def test_falls_back_to_env_vars_when_vault_url_is_empty_string(self):
        ...
        with patch.dict(os.environ, env_vars):
            service = SchwabService(vault_url="")
            creds = service.get_credentials()
    ...
    def test_loads_credentials_from_azure_keyvault_when_vault_url_provided(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            with patch("backend.services.schwab_service.SecretClient") as mock_sc_cls, \
                ...
                service = SchwabService(vault_url="https://myvault.vault.azure.net/")
                creds = service.get_credentials()
